...
TextStyle kLoginOrSignUpTextStyle2(
  Size size,
   ...
   GoogleFonts.ubuntu(fontSize: 15, color: Color.fromARGB(255, 108, 173, 159), height: 1.5);
  ...
  Size size,
   ...
   GoogleFonts.ubuntu(fontSize: 13, color: Color.fromARGB(255, 108, 173, 159), height: 1.5, fontWeight: FontWeight.w600);
